          ...
          <div class="row mlr_-20">
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 plr-20">
              <div class="product-item">
                ...
                <a href="product-page.html"> <img src="<?php echo THEME_URI; ?>/images/products/item-1.jpg" alt=""> </a>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 plr-20">
              <div class="product-item">
                <div class="product-image"> 
                <a href="product-page.html"> <img src="<?php echo THEME_URI; ?>/images/products/item-2.jpg" alt=""> </a>
                  <div class="product-detail-inner">
                    <div class="item-overlay">
                      <ul>
                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 plr-20">
              <div class="product-item">
              <div class="product-image"> 
                <a href="product-page.html"> <img src="<?php echo THEME_URI; ?>/images/products/item-3.jpg" alt=""> </a>
                <div class="product-detail-inner">
                  <div class="item-overlay">
                      <ul>
                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 plr-20">
              <div class="product-item">
                <div class="product-image"> 
                <a href="product-page.html"> <img src="<?php echo THEME_URI; ?>/images/products/item-4.jpg" alt=""> </a>
                  <div class="product-detail-inner">
                    <div class="item-overlay">
                      <ul>
                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 plr-20">
              ...
              <div class="sale-label"><span>Sale</span></div>
                <div class="product-image"> 
                <a href="product-page.html"> <img src="<?php echo THEME_URI; ?>/images/products/item-5.jpg" alt=""> </a>
                  <div class="product-detail-inner">
                    <div class="item-overlay">
                      <ul>
                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 plr-20">
              <div class="product-item">
                <div class="product-image"> 
                <a href="product-page.html"> <img src="<?php echo THEME_URI; ?>/images/products/item-6.jpg" alt=""> </a>
                  <div class="product-detail-inner">
                    <div class="item-overlay">
                      <ul>
                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 plr-20">
              ...
              <div class="sale-label"><span>Sale</span></div>
                <div class="product-image"> 
                <a href="product-page.html"> <img src="<?php echo THEME_URI; ?>/images/products/item-7.jpg" alt=""> </a>
                  <div class="product-detail-inner">
                    <div class="item-overlay">
                      <ul>
                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 plr-20">
              <div class="product-item">
                <div class="product-image"> 
                <a href="product-page.html"> <img src="<?php echo THEME_URI; ?>/images/products/item-8.jpg" alt=""> </a>
                  <div class="product-detail-inner">
                    <div class="item-overlay">
                      <ul>
                        <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
          ...
          <div class="row">
            <div class="owl-carousel pro_cat_slider">
              ...
              <div class="item">
                <div class="product-item">
                  <div class="sale-label"><span>Sale</span></div>
                  <div class="product-image"> <a href="product-page.html"> <img src="<?php echo THEME_URI; ?>/images/products/item-9.jpg" alt=" "> </a>
                    <div class="product-detail-inner">
                      <div class="item-overlay">
                        <ul>
                          <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
              ...
              <div class="item">
                <div class="product-item">
                  <div class="product-image"> 
                  <a href="product-page.html"> <img src="<?php echo THEME_URI; ?>/images/products/item-9.jpg" alt=" "> </a>
                    <div class="product-detail-inner">
                      <div class="item-overlay">
                        <ul>
                          <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="item">
                  <div class="product-item">
                    <div class="product-image"> 
                    <a href="product-page.html"> <img src="<?php echo THEME_URI; ?>/images/products/item-10.jpg" alt=" "> </a>
                      <div class="product-detail-inner">
                        <div class="item-overlay">
                          <ul>
                            <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                  ...
                  <div class="item">
                    <div class="product-item">
                      <div class="product-image"> 
                      <a href="product-page.html"> <img src="<?php echo THEME_URI; ?>/images/products/item-11.jpg" alt=" "> </a>
                        <div class="product-detail-inner">
                          <div class="item-overlay">
                            <ul>
                              <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
